...
public class ItemInfo
{
    ...
    public static final String ClockKey = "ClockKey";
    public static final int ClockDefault = 12675;
    public static final String ClockUnlocalized = "Clock";
    public static final String ClockName = "§6§lClock";
    public static final String ClockTexture = "Clock";

    public static int WrenchID;
    public static final String WrenchKey = "Wrench";
    public static final int WrenchDefault = 12676;
    public static final String WrenchUnlocalized = "CwWrench";
    public static final String WrenchName = "§6§lClockwork Wrench";
    public static final String WrenchTextureActivated01 = "WrenchActivated01";
    public static final String WrenchTextureActivated02 = "WrenchActivated02";
    ...
    public static final String CraftingComponetUnloaclized = "CraftingComponent";
